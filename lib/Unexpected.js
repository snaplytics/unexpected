...
Unexpected.prototype.fail = function (arg, optionsIfFirstArgIsErrorInstance) {
    ...
    if (utils.isError(arg)) {
        if (optionsIfFirstArgIsErrorInstance) {
            error = arg;
            arg = optionsIfFirstArgIsErrorInstance;
        } else {
            throw arg;
        }
    } else {
        error = new UnexpectedError(this.expect);
    }
